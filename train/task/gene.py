...
class EmbeddingDataset(Dataset):
    def __init__(self, dataset_csv:str, embed_path:str, split_col:str='split_col', split:str='train', id_col:str='id', type_col:list=['IDH1','TP53','ATRX','PTEN','EGFR','TERT'], z_score=False):
        """
    ...
    def __getitem__(self, index):
        ...
        return embed.squeeze(0), torch.tensor(category, dtype=torch.float32)
